...
const Navigation = ({ activeSection, setActiveSection }) => {
    ...
    const memberNavItems = [
        ...
        { id: 'logout', label: 'Logout', description: 'Sign out of your account' }
    ];
    ...
    if (isAuthenticated && !hasRole(['super_admin', 'admin', 'editor'])) {
        navItems = [{ id: 'user-dashboard', label: 'My Dashboard', description: 'Your member dashboard' }, ...navItems.filter(i => i.id !== 'home')];
        navItems.unshift({ id: 'home', label: 'Home', description: 'Dashboard and updates' });
        navItems = navItems.filter((item, index, self) => self.findIndex(i => i.id === item.id) === index);
    }
    ...
    const getIcon = (id) => {
        const icons = {
            ...
            'user-dashboard': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
        };
